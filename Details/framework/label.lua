...
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
	...
	local smember_textfont = function(_object, _value)
		return _details:SetFontFace(_object.label, _value)
	end
	--> text size
	local smember_textsize = function(_object, _value)
		return _details:SetFontSize(_object.label, _value)
	end
	--> text align
	...
	local smember_outline = function(_object, _value)
		_details:SetFontOutline(_object.label, _value)
	end
...
function gump:NewLabel(parent, container, name, member, text, font, size, color, layer)
	...
	if (size) then
		_details:SetFontSize(LabelObject.label, size)
	end
