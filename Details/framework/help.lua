...
local nameCounter = 1
function _details.gump:NewHelp(parent, width, height, x, y, buttonWidth, buttonHeight, name)
	...
	local helpButton = CreateFrame("button", name or "DetailsHelpButton"..nameCounter, parent, "DetailsButtonTemplate")
