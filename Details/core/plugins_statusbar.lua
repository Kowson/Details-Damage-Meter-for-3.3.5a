...
--[[	This file contains Api and Internal functions, plus 4 built-in plugins  
	...
	function _details.StatusBar:ReloadAnchors(instance)
		...
		if (not instance.show_statusbar and instance.micro_displays_side == 2) then
			_details.StatusBar:Hide(instance)
		end
	end
	...
	function _details.StatusBar:CreateChildFrame(instance, name, w, h)
		...
		local frame = _details.gump:NewPanel(instance.baseframe, nil, name..instance:GetInstanceId(), nil, w or DEFAULT_CHILD_WIDTH, h or DEFAULT_CHILD_HEIGHT, false)
